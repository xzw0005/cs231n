...
class Solver(object):
    ...
    def _reset(self):
        ...
        self.best_val_acc = 0
        self.best_params = {}
        self.loss_history, self.train_acc_history, self.val_acc_history = [], [], []
        self.optim_configs = {}
    ...
    def _save_checkpoint(self):
        ...
        fname = '%s_epoch%d.pkl' % (self.checkpoint_name, self.epoch)
        if self.verbose:
            print('Saving checkpoint to "%s"' % fname)
